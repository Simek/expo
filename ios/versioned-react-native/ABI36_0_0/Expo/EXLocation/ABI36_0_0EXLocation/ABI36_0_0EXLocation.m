...
#import <ABI36_0_0EXLocation/ABI36_0_0EXLocation.h>
#import <ABI36_0_0EXLocation/ABI36_0_0EXLocationDelegate.h>
#import <ABI36_0_0EXLocation/ABI36_0_0EXLocationTaskConsumer.h>
#import <ABI36_0_0EXLocation/ABI36_0_0EXGeofencingTaskConsumer.h>
#import <ABI36_0_0EXLocation/ABI36_0_0EXLocationPermissionRequester.h>
...
NSString * const ABI36_0_0EXLocationChangedEventName = @"Expo.locationChanged";
NSString * const ABI36_0_0EXHeadingChangedEventName = @"Expo.headingChanged";

@interface ABI36_0_0EXLocation ()

@property (nonatomic, strong) NSMutableDictionary<NSNumber *, ABI36_0_0EXLocationDelegate*> *delegates;
@property (nonatomic, strong) NSMutableSet<ABI36_0_0EXLocationDelegate *> *retainedDelegates;
...
@property (nonatomic, weak) id<ABI36_0_0UMAppLifecycleService> lifecycleService;
@property (nonatomic, weak) id<ABI36_0_0UMTaskManagerInterface> tasksManager;

@end

@implementation ABI36_0_0EXLocation

ABI36_0_0UM_EXPORT_MODULE(ExpoLocation);
...
- (void)setModuleRegistry:(ABI36_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI36_0_0UMPermissionsMethodsDelegate registerRequesters:@[[ABI36_0_0EXLocationPermissionRequester new]] withPermissionsManager:_permissionsManager];
  _lifecycleService = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMAppLifecycleService)];
  _tasksManager = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI36_0_0UMTaskManagerInterface)];
...
{
  return @[ABI36_0_0EXLocationChangedEventName, ABI36_0_0EXHeadingChangedEventName];
}
...
ABI36_0_0UM_EXPORT_METHOD_AS(getProviderStatusAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(getCurrentPositionAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  __block ABI36_0_0EXLocationDelegate *delegate;

  delegate = [[ABI36_0_0EXLocationDelegate alloc] initWithId:nil withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> * _Nonnull locations) {
    if (delegate != nil) {
      if (locations.lastObject != nil) {
        resolve([ABI36_0_0EXLocation exportLocation:locations.lastObject]);
      } else {
...
ABI36_0_0UM_EXPORT_METHOD_AS(watchPositionImplAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  ABI36_0_0EXLocationDelegate *delegate = [[ABI36_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations:^(NSArray<CLLocation *> *locations) {
    if (locations.lastObject != nil && weakSelf != nil) {
      ...
      NSDictionary *body = @{
                             @"watchId": watchId,
                             @"location": [ABI36_0_0EXLocation exportLocation:loc],
                             };

      [strongSelf->_eventEmitter sendEventWithName:ABI36_0_0EXLocationChangedEventName body:body];
    }
  } onUpdateHeadings:nil onError:^(NSError *error) {
    // TODO: report errors
...
ABI36_0_0UM_EXPORT_METHOD_AS(watchDeviceHeading,
  ...
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI36_0_0EXLocationPermissionRequester class]]) {
  ...
  ABI36_0_0EXLocationDelegate *delegate = [[ABI36_0_0EXLocationDelegate alloc] initWithId:watchId withLocMgr:locMgr onUpdateLocations: nil onUpdateHeadings:^(CLHeading *newHeading) {
    if (newHeading != nil && weakSelf != nil) {
      ...
      [strongSelf->_eventEmitter sendEventWithName:ABI36_0_0EXHeadingChangedEventName body:body];
    }
...
ABI36_0_0UM_EXPORT_METHOD_AS(removeWatchAsync,
                    watchId:(nonnull NSNumber *)watchId
                    resolver:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ABI36_0_0EXLocationDelegate *delegate = _delegates[watchId];
...
ABI36_0_0UM_EXPORT_METHOD_AS(geocodeAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(reverseGeocodeAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  [ABI36_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI36_0_0EXLocationPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}
...
ABI36_0_0UM_EXPORT_METHOD_AS(hasServicesEnabledAsync,
                    hasServicesEnabled:(ABI36_0_0UMPromiseResolveBlock)resolve
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
...
ABI36_0_0UM_EXPORT_METHOD_AS(startLocationUpdatesAsync,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI36_0_0EXLocationTaskConsumer class] options:options];
  }
  @catch (NSException *e) {
...
ABI36_0_0UM_EXPORT_METHOD_AS(stopLocationUpdatesAsync,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI36_0_0EXLocationTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI36_0_0UM_EXPORT_METHOD_AS(hasStartedLocationUpdatesAsync,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI36_0_0EXLocationTaskConsumer class]]));
}

# pragma mark - Geofencing

ABI36_0_0UM_EXPORT_METHOD_AS(startGeofencingAsync,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager registerTaskWithName:taskName consumer:[ABI36_0_0EXGeofencingTaskConsumer class] options:options];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI36_0_0UM_EXPORT_METHOD_AS(stopGeofencingAsync,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  @try {
    [_tasksManager unregisterTaskWithName:taskName consumerClass:[ABI36_0_0EXGeofencingTaskConsumer class]];
  } @catch (NSException *e) {
    return reject(e.name, e.reason, nil);
  }
  resolve(nil);
...
ABI36_0_0UM_EXPORT_METHOD_AS(hasStartedGeofencingAsync,
                    ...
                    reject:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve(@([_tasksManager taskWithName:taskName hasConsumerOfClass:[ABI36_0_0EXGeofencingTaskConsumer class]]));
}
...
- (CLLocationManager *)locationManagerWithOptions:(NSDictionary *)options
{
  ...
  if (options[@"accuracy"]) {
    ABI36_0_0EXLocationAccuracy accuracy = [options[@"accuracy"] unsignedIntegerValue] ?: ABI36_0_0EXLocationAccuracyBalanced;
    locMgr.desiredAccuracy = [self.class CLLocationAccuracyFromOption:accuracy];
  }
  return locMgr;
}

- (BOOL)checkPermissions:(ABI36_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkTaskManagerExists:(ABI36_0_0UMPromiseRejectBlock)reject
{
...
- (BOOL)checkBackgroundServices:(ABI36_0_0UMPromiseRejectBlock)reject
{
...
{
  switch (accuracy) {
    case ABI36_0_0EXLocationAccuracyLowest:
      return kCLLocationAccuracyThreeKilometers;
    case ABI36_0_0EXLocationAccuracyLow:
      return kCLLocationAccuracyKilometer;
    case ABI36_0_0EXLocationAccuracyBalanced:
      return kCLLocationAccuracyHundredMeters;
    case ABI36_0_0EXLocationAccuracyHigh:
      return kCLLocationAccuracyNearestTenMeters;
    case ABI36_0_0EXLocationAccuracyHighest:
      return kCLLocationAccuracyBest;
    case ABI36_0_0EXLocationAccuracyBestForNavigation:
