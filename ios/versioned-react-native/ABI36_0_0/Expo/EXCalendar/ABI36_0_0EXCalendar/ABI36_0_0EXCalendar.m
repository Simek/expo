...
#import <ABI36_0_0EXCalendar/ABI36_0_0EXCalendar.h>
#import <ABI36_0_0EXCalendar/ABI36_0_0EXCalendarConverter.h>
...
@implementation ABI36_0_0EXCalendar

ABI36_0_0UM_EXPORT_MODULE(ExpoCalendar);
...
- (void)setModuleRegistry:(ABI36_0_0UMModuleRegistry *)moduleRegistry
{
  ...
  [ABI36_0_0UMPermissionsMethodsDelegate registerRequesters:@[
                                                    [ABI36_0_0EXCalendarPermissionRequester new],
                                                    [ABI36_0_0EXRemindersPermissionRequester new]
                                                    ]
...
ABI36_0_0UM_EXPORT_METHOD_AS(getCalendarsAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI36_0_0EXCalendarConverter serializeCalendars:calendars]);
}

ABI36_0_0UM_EXPORT_METHOD_AS(getDefaultCalendarAsync,
                    getDefaultCalendarAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejector:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI36_0_0EXCalendarConverter serializeCalendar:defaultCalendar]);
}

ABI36_0_0UM_EXPORT_METHOD_AS(saveCalendarAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (color) {
    calendar.CGColor = [ABI36_0_0UMUtilities UIColor:color].CGColor;
...
ABI36_0_0UM_EXPORT_METHOD_AS(deleteCalendarAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(getEventsAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI36_0_0UMUtilities NSDate:startDateStr];
  NSDate *endDate = [ABI36_0_0UMUtilities NSDate:endDateStr];
  ...
  if (calendarEvents) {
    resolve([ABI36_0_0EXCalendarConverter serializeCalendarEvents:calendarEvents]);
...
ABI36_0_0UM_EXPORT_METHOD_AS(getEventByIdAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (calendarEvent) {
    resolve([ABI36_0_0EXCalendarConverter serializeCalendarEvent:calendarEvent]);
  } else {
...
ABI36_0_0UM_EXPORT_METHOD_AS(saveEventAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI36_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *endDate = [ABI36_0_0UMUtilities NSDate:details[@"endDate"]];
  NSDate *instanceStartDate = [ABI36_0_0UMUtilities NSDate:details[@"instanceStartDate"]];
  ...
  if (recurrenceRule) {
    ...
    if (recurrenceRule[@"endDate"]) {
      endDate = [ABI36_0_0UMUtilities NSDate:recurrenceRule[@"endDate"]];
    }
...
ABI36_0_0UM_EXPORT_METHOD_AS(deleteEventAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *instanceStartDate = [ABI36_0_0UMUtilities NSDate:event[@"instanceStartDate"]];
...
ABI36_0_0UM_EXPORT_METHOD_AS(getAttendeesForEventAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (item.hasAttendees) {
    resolve([ABI36_0_0EXCalendarConverter serializeAttendees:item.attendees]);
  } else {
    resolve([[NSArray alloc] init]);
  }
}

ABI36_0_0UM_EXPORT_METHOD_AS(getRemindersAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  [self.eventStore fetchRemindersMatchingPredicate:predicate completion:^(NSArray<EKReminder *> *reminders) {
    if (!reminders) {
      ...
      resolve([ABI36_0_0EXCalendarConverter serializeReminders:reminders]);
    }
  }];
}

ABI36_0_0UM_EXPORT_METHOD_AS(getReminderByIdAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  if (reminder) {
    ...
    resolve([ABI36_0_0EXCalendarConverter serializeReminder:reminder]);
  } else {
    reject(@"E_REMINDER_NOT_FOUND",
...
ABI36_0_0UM_EXPORT_METHOD_AS(saveReminderAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  NSDate *startDate = [ABI36_0_0UMUtilities NSDate:details[@"startDate"]];
  NSDate *dueDate = [ABI36_0_0UMUtilities NSDate:details[@"dueDate"]];
  NSDate *completionDate = [ABI36_0_0UMUtilities NSDate:details[@"completionDate"]];
...
ABI36_0_0UM_EXPORT_METHOD_AS(deleteReminderAsync,
...
ABI36_0_0UM_EXPORT_METHOD_AS(getSourcesAsync,
                    getSourcesAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  for (EKSource *source in sources) {
    [serializedSources addObject:[ABI36_0_0EXCalendarConverter serializeSource:source]];
  }
  resolve(serializedSources);
}

ABI36_0_0UM_EXPORT_METHOD_AS(getSourceByIdAsync,
                    ...
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  ...
  resolve([ABI36_0_0EXCalendarConverter serializeSource:source]);
}

ABI36_0_0UM_EXPORT_METHOD_AS(getCalendarPermissionsAsync,
                    getCalendarPermissionsAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  [ABI36_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI36_0_0EXCalendarPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI36_0_0UM_EXPORT_METHOD_AS(requestCalendarPermissionsAsync,
                    requestCalendarPermissionsAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
...
ABI36_0_0UM_EXPORT_METHOD_AS(getRemindersPermissionsAsync,
                    getRemindersPermissionsAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  [ABI36_0_0UMPermissionsMethodsDelegate getPermissionWithPermissionsManager:_permissionsManager
                                                      withRequester:[ABI36_0_0EXRemindersPermissionRequester class]
                                                            resolve:resolve
                                                             reject:reject];
}

ABI36_0_0UM_EXPORT_METHOD_AS(requestRemindersPermissionsAsync,
                    requestRemindersPermissionsAsync:(ABI36_0_0UMPromiseResolveBlock)resolve
                    rejecter:(ABI36_0_0UMPromiseRejectBlock)reject)
{
  [ABI36_0_0UMPermissionsMethodsDelegate askForPermissionWithPermissionsManager:_permissionsManager
                                                         withRequester:[ABI36_0_0EXRemindersPermissionRequester class]
...
- (EKAlarm *)_createCalendarEventAlarm:(NSDictionary *)alarm
{
  ...
  NSDate *date = [ABI36_0_0UMUtilities NSDate:alarm[@"absoluteDate"]];
...
- (BOOL)_checkPermissions:(Class)permissionsRequester reject:(ABI36_0_0UMPromiseRejectBlock)reject
{
  if (![_permissionsManager hasGrantedPermissionUsingRequesterClass:[ABI36_0_0EXCalendarPermissionRequester class]]) {
...
- (BOOL)_checkCalendarPermissions:(ABI36_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:[ABI36_0_0EXCalendarPermissionRequester class] reject:reject];
}

- (BOOL)_checkRemindersPermissions:(ABI36_0_0UMPromiseRejectBlock)reject
{
  return [self _checkPermissions:[ABI36_0_0EXRemindersPermissionRequester class] reject:reject];
}
